...
function getProducts() {
  ...
  if (!products) {
    ...
    products = [
      { id: 1, brand: 'Nike', name: 'Air Max 270 React', category: 'men', price: 18500, oldPrice: 24000, badge: 'sale', rating: 4.8, reviews: 214, image: 'https://images.unsplash.com/photo-1615743472612-93b21e520fad?q=80&w=800&auto=format&fit=crop', sizes: '6,7,8,9,10,11,12', description: 'The Nike Air Max 270 React combines two of Nike\'s most innovative cushioning technologies.', inStock: true },
      { id: 2, brand: 'Adidas', name: 'Ultraboost 23', category: 'sport', price: 21000, oldPrice: null, badge: 'new', rating: 4.9, reviews: 187, image: 'https://images.unsplash.com/photo-1571008887538-b36bb32f4571?q=80&w=800&auto=format&fit=crop', sizes: '6,7,8,9,10,11', description: 'Engineered for elite performance with BOOST midsole technology.', inStock: true },
      { id: 3, brand: 'Steve Madden', name: 'Elara Stiletto Heels', category: 'women', price: 9800, oldPrice: 14500, badge: 'sale', rating: 4.7, reviews: 92, image: 'https://images.unsplash.com/photo-1551489186-ccb95a1ea6a3?q=80&w=800&auto=format&fit=crop', sizes: '4,5,6,7,8,9', description: 'The Elara stiletto is the epitome of elegant femininity.', inStock: true },
      { id: 4, brand: 'Timberland', name: 'Premium Loafer', category: 'casual', price: 13500, oldPrice: null, badge: 'hot', rating: 4.6, reviews: 143, image: 'https://images.unsplash.com/photo-1616406432452-07bc5938759d?q=80&w=800&auto=format&fit=crop', sizes: '6,7,8,9,10,11,12', description: 'Crafted from full-grain leather with a padded collar.', inStock: true },
      { id: 5, brand: 'Jordan', name: 'Air Jordan 1 Retro High', category: 'men', price: 32000, oldPrice: 38000, badge: 'sale', rating: 4.9, reviews: 512, image: 'https://images.unsplash.com/photo-1552346154-21d32810aba3?q=80&w=800&auto=format&fit=crop', sizes: '7,8,9,10,11,12', description: 'The iconic Air Jordan 1 Retro High OG is a classic reimagined.', inStock: true },
      { id: 6, brand: 'Puma', name: 'Nitro Runner Elite', category: 'sport', price: 15800, oldPrice: null, badge: 'new', rating: 4.5, reviews: 76, image: 'https://images.unsplash.com/photo-1562183241-b937e95585b6?q=80&w=800&auto=format&fit=crop', sizes: '6,7,8,9,10,11', description: 'Built for speed and endurance with NITRO foam technology.', inStock: true },
      { id: 7, brand: 'Aldo', name: 'Strappy Sandal Heels', category: 'women', price: 7200, oldPrice: 10800, badge: 'sale', rating: 4.4, reviews: 61, image: 'https://images.unsplash.com/photo-1524553879936-2ff074ae5816?q=80&w=800&auto=format&fit=crop', sizes: '4,5,6,7,8', description: 'ALDO Strappy Sandal Heels feature delicate ankle straps.', inStock: true },
      { id: 8, brand: 'Skechers', name: 'Arch Fit Loafer', category: 'casual', price: 8900, oldPrice: 11000, badge: 'sale', rating: 4.6, reviews: 208, image: 'https://images.unsplash.com/photo-1615979474401-8a6a344de5bd?q=80&w=800&auto=format&fit=crop', sizes: '6,7,8,9,10,11,12', description: 'Skechers Arch Fit Loafer features an orthopedic insole.', inStock: true }
    ];
