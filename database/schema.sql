...
VALUES
('Nike', 'Air Max 270 React', 'men', 18500, 24000, 'sale', 4.8, 214, 'https://images.unsplash.com/photo-1615743472612-93b21e520fad?q=80&w=800&auto=format&fit=crop', '6,7,8,9,10,11,12',
...
('Adidas', 'Ultraboost 23', 'sport', 21000, NULL, 'new', 4.9, 187, 'https://images.unsplash.com/photo-1571008887538-b36bb32f4571?q=80&w=800&auto=format&fit=crop', '6,7,8,9,10,11',
...
('Steve Madden', 'Elara Stiletto Heels', 'women', 9800, 14500, 'sale', 4.7, 92, 'https://images.unsplash.com/photo-1551489186-ccb95a1ea6a3?q=80&w=800&auto=format&fit=crop', '4,5,6,7,8,9',
...
('Timberland', 'Premium Loafer', 'casual', 13500, NULL, 'hot', 4.6, 143, 'https://images.unsplash.com/photo-1616406432452-07bc5938759d?q=80&w=800&auto=format&fit=crop', '6,7,8,9,10,11,12',
...
('Jordan', 'Air Jordan 1 Retro High', 'men', 32000, 38000, 'sale', 4.9, 512, 'https://images.unsplash.com/photo-1552346154-21d32810aba3?q=80&w=800&auto=format&fit=crop', '7,8,9,10,11,12',
...
('Puma', 'Nitro Runner Elite', 'sport', 15800, NULL, 'new', 4.5, 76, 'https://images.unsplash.com/photo-1562183241-b937e95585b6?q=80&w=800&auto=format&fit=crop', '6,7,8,9,10,11',
...
('Aldo', 'Strappy Sandal Heels', 'women', 7200, 10800, 'sale', 4.4, 61, 'https://images.unsplash.com/photo-1524553879936-2ff074ae5816?q=80&w=800&auto=format&fit=crop', '4,5,6,7,8',
...
('Skechers', 'Arch Fit Loafer', 'casual', 8900, 11000, 'sale', 4.6, 208, 'https://images.unsplash.com/photo-1615979474401-8a6a344de5bd?q=80&w=800&auto=format&fit=crop', '6,7,8,9,10,11,12',
